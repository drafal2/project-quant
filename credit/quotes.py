...
class CdsQuote:
    ...
    def __init__(  # TODO: must be possible to add optional parameter - maturity_date
                   # TODO: maybe it is worth adding quote date and then _spot, start_date etc. is just a property without passing ref date?
        self,
        spread: float,
        tenor: str,
        spot_lag: int = 0,
    ...
    def maturity_date(self, reference_date: date) -> date:
        ...
        With ``MaturityReference.PAYMENT_DATE`` it is the accrual end advanced by
        ``payment_lag`` business days.
        """
        cal = HolidayCalendar(self._calendar)
